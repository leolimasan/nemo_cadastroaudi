(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
            ...
            "fields": [
              {
                ...
                "incorrectText": "*preencha o campo modelo corretamente",
                "placeholderTag": "",
                "tag": "select",
                "attr": {
                  "name": "vehiclemodel",
  ...
  FormLead = (function() {
    ...
    FormLead.prototype._setupStyle = function(){
      console.log("FormLead::setupStyle");
      this.config.theme = this.getParameterByName('theme') || 'default';
      $('body').addClass( 'theme-'+ this.config.theme );
    }
    ...
    FormLead.prototype._buildFields = function() {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        field = ref[i];
        var bg = this.config.theme === "dark" ? {"backgroundImage": "url('./images/form/form_group_bg_dark.png')"} : {"backgroundImage": "url('./images/form/form_group_bg.png')"};
        this._background = field.background === "none" ? {} : bg;
    ...
    FormLead.prototype._populateVehicleModels = function() {
      ...
      _loading.remove();
      this._vehicles = VEHICLES_MODELS_LIST;
      results1 = [];
      for (i = 0, len = VEHICLES_MODELS_LIST.length; i < len; i++) {
        vehicleModel = VEHICLES_MODELS_LIST[i];
        results1.push(_formSelect.append($('<option/>').text(vehicleModel.name).attr('value', vehicleModel.idSalesforce)));
      }

      this.formComponent.changeCar();
      return results1;
      ...
      //       for (i = 0, len = data.length; i < len; i++) {
      //         vehicleModel = data[i];
      //         if( VEHICLES_AVAILABLE_ON_SELECT.indexOf( vehicleModel.idSalesforce ) > -1 ){
      //             results1.push(_formSelect.append($('<option/>').text(vehicleModel.name).attr('value', vehicleModel.idSalesforce)));
      //         }
      //       }
