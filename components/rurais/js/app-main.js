...
},{"./base.js":2,"./formCorporativo.js":3, "./pt-br.js":5,"./radioCustom.js":6}],2:[function(require,module,exports){
(function(){
			...
			return function(event){
				...
				$.ajax({ 
					...
					data: {
						...
						"idCity": _this.idCity,
						"idSite": $(".form-horizontal-pf").attr("data-id-site").toString(),
						"idDealer[]" : dealers,
